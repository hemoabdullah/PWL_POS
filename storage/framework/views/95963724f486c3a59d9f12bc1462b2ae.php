<div class="modal fade" id="importExcelItemAjaxModal" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('items.import-excel-ajax')); ?>" method="POST" id="importExcelItemAjaxForm">
                <?php echo csrf_field(); ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\laragon\www\week-3\pwl-pos\resources\views/pages/item/components/import-excel-data-ajax.blade.php ENDPATH**/ ?>