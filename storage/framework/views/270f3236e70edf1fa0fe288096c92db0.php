...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="form-group">
                            ...
                            <input type="number" name="stock_qty" id="stock_qty" class="form-control" value="<?php echo e(old('stock_qty')); ?>">
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\pwl-pos\resources\views/pages/stock/store.blade.php ENDPATH**/ ?>