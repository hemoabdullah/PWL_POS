<div class="modal fade" id="newLevelAjaxModal" tabindex="-1" role="dialog" aria-labelledby="newLevelAjaxModalLabel"
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('levels.store-ajax')); ?>" method="POST" id="addNewLevelAjaxForm">
                <?php echo csrf_field(); ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\laragon\www\week-3\pwl-pos\resources\views/pages/level/components/store-ajax.blade.php ENDPATH**/ ?>