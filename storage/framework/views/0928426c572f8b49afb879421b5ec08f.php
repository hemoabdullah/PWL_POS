<div class="modal fade" id="newItemAjaxModal" tabindex="-1" role="dialog" aria-labelledby="newItemAjaxModalLabel"
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('items.store-ajax')); ?>" method="POST" id="addNewItemAjaxForm">
                <?php echo csrf_field(); ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\laragon\www\week-3\pwl-pos\resources\views/pages/item/components/store-ajax.blade.php ENDPATH**/ ?>